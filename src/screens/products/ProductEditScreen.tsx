/**
 * Product Edit Screen
 * Form for editing existing products with validation
 */
...
import {useProduct, useUpdateProduct, useCategories} from '@hooks/queries/useProducts';
...
export const ProductEditScreen: React.FC<Props> = ({navigation, route}) => {
